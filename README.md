...
This python script tries to guess that number in the least amount possible of attempts, averaging around `~5.47588` (avg after 100,000 reps) guesses per game
